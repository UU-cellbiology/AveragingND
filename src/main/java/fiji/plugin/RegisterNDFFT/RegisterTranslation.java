...
public class RegisterTranslation
{
	...
	public long[] registerTranslation(final Img< FloatType > image_in, final Img< FloatType > template_in) //throws ImgIOException, IncompatibleTypeException
	{
		...
		ImagePlus registeredT = ImageJFunctions.wrap(Views.interval(Views.translate(Views.extendZero(template_in), shift_pos),image_in),"registered_template");
		if(nDim>2)
		{
			registeredT.setDimensions(1, (int)ivCC.dimension(2), 1);
		}
		registeredT.show();
